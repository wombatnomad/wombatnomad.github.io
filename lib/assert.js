    ...
    static throws(type, f) {
        ...
        try {
            ...
            if (e instanceof type) {
                ...
                throw new AssertionError(`Expected ${type} to be thrown but got ${repr(e)}`);
            }
        }
        if (!thrown) {
            throw new AssertionError(`Expected ${type} to be thrown but none was thrown`);
        }
    }
}
