...
const BASE_SPECS = [
    ...
    },
    {
        // newlines
        re: /\n+/,
        f: s => [new AToken(s.filename, s.lastIndex, ATOKEN_TYPE_NEWLINE)],
    },
    {
        // identifiers
    ...
    },
    {
        // hex literal
        re: /0x[0-9a-fA-F]+/,
        f: s => [new AToken(s.filename, s.lastIndex, ATOKEN_TYPE_NUMBER, parseInt(s.text, 16))],
    },
    {
        // base 10 number with explicit '.'
        re: /[0-9]*\.[0-9]+(?:e(?:\+|-)?\d+)?/,
        f: s => [new AToken(s.filename, s.lastIndex, ATOKEN_TYPE_NUMBER, parseFloat(s.text))],
    },
    {
    ...
    },
    {
        ...
        re: /\"(?:\\\"|[^"])*\"/,
        f: s => [new AToken(s.filename, s.lastIndex, ATOKEN_TYPE_STRING, eval(s.text))],
    },
    {
...
export class ALexer {
    ...
    constructor(opts) {
        ...
        specs.push({
            ...
            f: s => [new AToken(s.filename, s.lastIndex, s.text)],
        });
